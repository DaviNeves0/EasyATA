            ...
            <MaterialTable
                ...
                columns={[
                    ...
                    { title: 'Local', field: 'local' },
                    {
                        ...
                        defaultFilter: 'Nova',
                        // filterComponent: () => <input value="Nova" />,
                        filtering: false,
                        // lookup: {'Nova': 'Nova','Aprovado' : 'Aprovado', 'Reprovado': 'Reprovado', 'Pendente': 'Pendente'}
                    }
                ]}
                ...
                //         icon: () => <HowToRegIcon />,
                //         tooltip: 'Assinar',
                //         onClick: (event, rowData) => {this.handleApprove(rowData)}
                //     }) 
                //   ]}
                options={{
