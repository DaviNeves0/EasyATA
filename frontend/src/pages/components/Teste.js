...
const tableIcons = {
    ...
    Show: forwardRef((props, ref) => <RemoveRedEyeIcon {...props} ref={ref} />),
    ...
    render(){      
        return (
            ...
            columns={[
                ...
                lookup: {'Aprovado' : 'Aprovado', 'Pendente': 'Pendente', 'Nova': 'Nova', 'Reprovado': 'Reprovado', 'Assinada': 'Assinada'},
                }
              ]}
            ...
            //         tooltip: 'Visualizar',
            //         onClick: (event, rowData) => {this.handleShow(rowData)}
            ...
            //   ]}
             ...
             detailPanel={rowData => {
                const header = [ "Tema","Pauta","Data_Inicio","Data_Fim", "Hora_Inicio","Hora_Fim","Local","Participante",
                "Area", "Email", "Telefone","Assunto","Responsavel","Prazo","Distribuicao", 
             ...
             <div className="card shadow" style={{margin:'5%'}}>
                     ...
                     <div className="card-body">
                         <form>                       
                             <div>
                                     <div className="form-group row">                                      
                                         <div className="col">
                                             <textarea type="text" className="form-control" name="representante" placeholder="Representante1, Representante2"  value={rowData.representante}
                                            />       
                                         </div> 
                                         <div className="col">
                                             <textarea type="text" className="form-control" name="nome" placeholder="Nome1, Nome2" value={rowData.nome}
                                            />       
                                         </div> 
                                         <div className="col">
                                             <textarea type="text" className="form-control" name="assinatura" placeholder="Assinatura, Assinatura2" value={rowData.assinatura}
                                             />       
                                         </div>             
                                     </div>             
                                 </div>                                                                                   
                 ...
                 <CSVLink data={JSON.stringify(rowData)} headers={header} ><button className="btn btn-outline-success"> CSV</button></CSVLink>
                <Link to="/revisao"> <button className="btn btn-outline-primary" id="revisao"> Solicitar Revisão</button></Link>
